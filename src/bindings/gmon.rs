...
pub mod g_mon {
    ...
    fn __abi() -> ::ethers::core::abi::Abi {
        ::ethers::core::abi::ethabi::Contract {
            ...
            errors: ::core::convert::From::from([
                ...
                (
                    ::std::borrow::ToOwned::to_owned("NotGMonMinterBurner"),
                    ::std::vec![
                        ::ethers::core::abi::ethabi::AbiError {
                            name: ::std::borrow::ToOwned::to_owned(
                                "NotGMonMinterBurner",
                ...
                (
                    ::std::borrow::ToOwned::to_owned("NotTokenAdmin"),
                    ::std::vec![
                        ::ethers::core::abi::ethabi::AbiError {
                            name: ::std::borrow::ToOwned::to_owned("NotTokenAdmin"),
                            inputs: ::std::vec![],
                        },
                    ],
                ),
    ...
    pub static GMON_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(
        __abi,
    );
    pub struct gMON<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for gMON<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for gMON<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for gMON<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for gMON<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(gMON)).field(&self.address()).finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> gMON<M> {
        ...
        pub fn initialize(
            ...
            self.0
                .method_hash([196, 214, 109, 232], role_manager)
                .expect("method not found (this should never happen)")
        }
        ...
        pub fn events(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, gMONEvents> {
    ...
    ///Custom Error type `NotGMonMinterBurner` with signature `NotGMonMinterBurner()` and selector `0xde5a25a7`
    #[derive(
        Clone,
        ::ethers::contract::EthError,
        ::ethers::contract::EthDisplay,
    ...
    #[etherror(name = "NotGMonMinterBurner", abi = "NotGMonMinterBurner()")]
    pub struct NotGMonMinterBurner;
    ...
    ///Custom Error type `NotTokenAdmin` with signature `NotTokenAdmin()` and selector `0x54e2bf5d`
    #[derive(
        Clone,
        ::ethers::contract::EthError,
        ::ethers::contract::EthDisplay,
    ...
    #[etherror(name = "NotTokenAdmin", abi = "NotTokenAdmin()")]
    pub struct NotTokenAdmin;
    ...
    pub enum gMONErrors {
        ...
        NotGMonMinterBurner(NotGMonMinterBurner),
        NotInitializing(NotInitializing),
        NotTokenAdmin(NotTokenAdmin),
        /// The standard solidity revert string, with selector
        /// Error(string) -- 0x08c379a0
        RevertString(::std::string::String),
    }
    impl ::ethers::core::abi::AbiDecode for gMONErrors {
        fn decode(
            data: impl AsRef<[u8]>,
            ...
            if let Ok(decoded) = <NotGMonMinterBurner as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::NotGMonMinterBurner(decoded));
            }
            ...
            if let Ok(decoded) = <NotTokenAdmin as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::NotTokenAdmin(decoded));
            }
            Err(::ethers::core::abi::Error::InvalidData.into())
        }
    }
    impl ::ethers::core::abi::AbiEncode for gMONErrors {
        fn encode(self) -> ::std::vec::Vec<u8> {
            match self {
                ...
                Self::NotGMonMinterBurner(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
                Self::NotInitializing(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
                Self::NotTokenAdmin(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
    ...
    impl ::ethers::contract::ContractRevert for gMONErrors {
        fn valid_selector(selector: [u8; 4]) -> bool {
            match selector {
                ...
                _ if selector
                    == <NotGMonMinterBurner as ::ethers::contract::EthError>::selector() => {
                    true
                }
                _ if selector
                ...
                _ if selector
                    == <NotTokenAdmin as ::ethers::contract::EthError>::selector() => {
                    true
                }
                _ => false,
            }
    ...
    impl ::core::fmt::Display for gMONErrors {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                ...
                Self::NotTokenAdmin(element) => ::core::fmt::Display::fmt(element, f),
                Self::RevertString(s) => ::core::fmt::Display::fmt(s, f),
            }
        }
    }
    impl ::core::convert::From<::std::string::String> for gMONErrors {
        fn from(value: String) -> Self {
            Self::RevertString(value)
        }
    }
    impl ::core::convert::From<ContractPaused> for gMONErrors {
        fn from(value: ContractPaused) -> Self {
            Self::ContractPaused(value)
        }
    }
    impl ::core::convert::From<ERC20InsufficientAllowance> for gMONErrors {
        fn from(value: ERC20InsufficientAllowance) -> Self {
            Self::ERC20InsufficientAllowance(value)
        }
    }
    impl ::core::convert::From<ERC20InsufficientBalance> for gMONErrors {
        fn from(value: ERC20InsufficientBalance) -> Self {
            Self::ERC20InsufficientBalance(value)
        }
    }
    impl ::core::convert::From<ERC20InvalidApprover> for gMONErrors {
        fn from(value: ERC20InvalidApprover) -> Self {
            Self::ERC20InvalidApprover(value)
        }
    }
    impl ::core::convert::From<ERC20InvalidReceiver> for gMONErrors {
        fn from(value: ERC20InvalidReceiver) -> Self {
            Self::ERC20InvalidReceiver(value)
        }
    }
    impl ::core::convert::From<ERC20InvalidSender> for gMONErrors {
        fn from(value: ERC20InvalidSender) -> Self {
            Self::ERC20InvalidSender(value)
        }
    }
    impl ::core::convert::From<ERC20InvalidSpender> for gMONErrors {
        fn from(value: ERC20InvalidSpender) -> Self {
            Self::ERC20InvalidSpender(value)
        }
    }
    impl ::core::convert::From<InvalidInitialization> for gMONErrors {
        fn from(value: InvalidInitialization) -> Self {
            Self::InvalidInitialization(value)
        }
    }
    impl ::core::convert::From<InvalidZeroInput> for gMONErrors {
        fn from(value: InvalidZeroInput) -> Self {
            Self::InvalidZeroInput(value)
        }
    }
    impl ::core::convert::From<NotGMonMinterBurner> for gMONErrors {
        fn from(value: NotGMonMinterBurner) -> Self {
            Self::NotGMonMinterBurner(value)
        }
    }
    impl ::core::convert::From<NotInitializing> for gMONErrors {
        fn from(value: NotInitializing) -> Self {
            Self::NotInitializing(value)
        }
    }
    impl ::core::convert::From<NotTokenAdmin> for gMONErrors {
        fn from(value: NotTokenAdmin) -> Self {
            Self::NotTokenAdmin(value)
        }
    }
    #[derive(
        Clone,
    ...
    impl ::ethers::contract::EthLogDecode for gMONEvents {
        fn decode_log(
            log: &::ethers::core::abi::RawLog,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::Error> {
            if let Ok(decoded) = ApprovalFilter::decode_log(log) {
                return Ok(gMONEvents::ApprovalFilter(decoded));
            }
            if let Ok(decoded) = InitializedFilter::decode_log(log) {
                return Ok(gMONEvents::InitializedFilter(decoded));
            }
            if let Ok(decoded) = TransferFilter::decode_log(log) {
                return Ok(gMONEvents::TransferFilter(decoded));
            }
            Err(::ethers::core::abi::Error::InvalidData)
        }
    }
    impl ::core::fmt::Display for gMONEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<ApprovalFilter> for gMONEvents {
        fn from(value: ApprovalFilter) -> Self {
            Self::ApprovalFilter(value)
        }
    }
    impl ::core::convert::From<InitializedFilter> for gMONEvents {
        fn from(value: InitializedFilter) -> Self {
            Self::InitializedFilter(value)
        }
    }
    impl ::core::convert::From<TransferFilter> for gMONEvents {
    ...
    impl ::ethers::core::abi::AbiDecode for gMONCalls {
        fn decode(
            data: impl AsRef<[u8]>,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::AbiError> {
            let data = data.as_ref();
    ...
    impl ::ethers::core::abi::AbiEncode for gMONCalls {
    ...
    impl ::core::fmt::Display for gMONCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<AllowanceCall> for gMONCalls {
        fn from(value: AllowanceCall) -> Self {
            Self::Allowance(value)
        }
    }
    impl ::core::convert::From<ApproveCall> for gMONCalls {
        fn from(value: ApproveCall) -> Self {
            Self::Approve(value)
        }
    }
    impl ::core::convert::From<BalanceOfCall> for gMONCalls {
        fn from(value: BalanceOfCall) -> Self {
            Self::BalanceOf(value)
        }
    }
    impl ::core::convert::From<BurnCall> for gMONCalls {
        fn from(value: BurnCall) -> Self {
            Self::Burn(value)
        }
    }
    impl ::core::convert::From<DecimalsCall> for gMONCalls {
        fn from(value: DecimalsCall) -> Self {
            Self::Decimals(value)
        }
    }
    impl ::core::convert::From<InitializeCall> for gMONCalls {
        fn from(value: InitializeCall) -> Self {
            Self::Initialize(value)
        }
    }
    impl ::core::convert::From<MintCall> for gMONCalls {
        fn from(value: MintCall) -> Self {
            Self::Mint(value)
        }
    }
    impl ::core::convert::From<NameCall> for gMONCalls {
        fn from(value: NameCall) -> Self {
            Self::Name(value)
        }
    }
    impl ::core::convert::From<PausedCall> for gMONCalls {
        fn from(value: PausedCall) -> Self {
            Self::Paused(value)
        }
    }
    impl ::core::convert::From<RoleManagerCall> for gMONCalls {
        fn from(value: RoleManagerCall) -> Self {
            Self::RoleManager(value)
        }
    }
    impl ::core::convert::From<SetPausedCall> for gMONCalls {
        fn from(value: SetPausedCall) -> Self {
            Self::SetPaused(value)
        }
    }
    impl ::core::convert::From<SymbolCall> for gMONCalls {
        fn from(value: SymbolCall) -> Self {
            Self::Symbol(value)
        }
    }
    impl ::core::convert::From<TotalSupplyCall> for gMONCalls {
        fn from(value: TotalSupplyCall) -> Self {
            Self::TotalSupply(value)
        }
    }
    impl ::core::convert::From<TransferCall> for gMONCalls {
        fn from(value: TransferCall) -> Self {
            Self::Transfer(value)
        }
    }
    impl ::core::convert::From<TransferFromCall> for gMONCalls {
